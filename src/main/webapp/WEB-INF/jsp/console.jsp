...
<div id="wrapper">
    ...
    <div class="panel-body">
        <p><a class="btn btn-primary btn-sm" href="<%=request.getContextPath()%>/write" role="button">写博客</a>
            <a class="btn btn-primary btn-sm" href="<%=request.getContextPath()%>/logout" role="button">登出</a>
        </p>
    </div>
    ...
    <div class="container">
        <c:forEach items="${cs}" var="c" >
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <p>${c.summary}</p>
                    <p>阅读：${c.read_times}    &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  时间：${c.last_edit_time}
                        <a class="btn btn-primary " href="<%=request.getContextPath()%>/showNote/${c.note_id}"  role="button">阅读全文</a>
                        <a class="btn btn-primary " href="<%=request.getContextPath()%>/editNote/${c.note_id}"  role="button">修&nbsp&nbsp&nbsp改 </a>
                        <a class="btn btn-primary " href="<%=request.getContextPath()%>/deleteNote/${c.note_id}"  role="button">删&nbsp&nbsp&nbsp除 </a>
                    </p>
                </div>
            </div>
        </c:forEach>
