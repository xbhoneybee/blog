...
<div id="wrapper">
    ...
    <div class="content-block parallax" >
        ...
        <!-- editormd end -->
        <form class="" action="<%=request.getContextPath()%>/updateNote/${c.note_id}" method="post" >
            <div class="container">
                <div class="input-group">
                    <span class="input-group-addon">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <input type="text" class="form-control" placeholder="${c.title}" name="T" value="${c.title}">
                    <span class="input-group-addon">&nbsp;&nbsp;&nbsp;&nbsp;</span>
                </div>
            </div>
            <!-- editormd start -->
            <div class="editormd" id="test-editormd">
                <textarea class="editormd-markdown-textarea" name="test-editormd-markdown-doc" id="editormd" >${c.content}</textarea>
